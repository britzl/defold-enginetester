Feature: go
	...
	Scenario: Spawn game object with callers position
		...
		And game object factory:/automation is positioned at 100,200,0
	...
	Scenario: Spawn game object with callers rotation
		...
		And game object factory:/automation is rotated 10,20,30 degrees
		When I use factory factory:/go#factory1 to spawn 1 game object
	...
	Scenario: Spawn game object with callers scale
		...
		And game object factory:/automation is scaled to 3,4,5
		When I use factory factory:/go#factory1 to spawn 1 game object
	...
	Scenario: Spawn game object with specific rotation
		...
		And game object factory:/automation is rotated 20,30,40 degrees
	...
	Scenario: Spawn game object with specific scale
		...
		And game object factory:/automation is scaled to 2,3,4
		When I use factory factory:/go#factory1 to spawn 1 game object with scale 3,4,5
		Then game object factory:/instance0 should be scaled to 3,4,5

	@factory
	@properties
	Scenario: Spawn game object with properties
		...
		And I use factory factory:/go#factory1 to spawn 1 game object with the prop_url property set to url factory:/automation#script
		...
		And game object factory:/instance2#script should have the prop_url property set to url factory:/automation#script
